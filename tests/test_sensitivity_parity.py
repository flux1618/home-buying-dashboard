...
CASES = [
    (310_000.0, 80_000.0, 0.0, 0.067, 0.0645, 320_000.0),
    (245_000.0, 50_000.0, 125.0, 0.06, 0.0725, 225_000.0),
    (80_000.0, 80_000.0, 0.0, 0.05, 0.075, 80_000.0),  # cash purchase: rate cannot invent P&I
]
...
def js_result(price, down, hoa, baseline_rate, future_rate, future_price):
    ...
    script = (
        HARNESS.replace(
            "__MILLS__", str(snapshot["global"]["tax"]["typical_owner_millage_mills"])
        )
